...
//	private static final String FINAL_SCORE = "50";
//
...
//		this.editor.finalScore.setValue(FINAL_SCORE);
//
//
...
//		this.editor.editCustomer(new Customer(FIRST_NAME, LAST_NAME,FINAL_SCORE));
//	}
//
