...
////
////		then(vaadinUI.grid.getColumns()).hasSize(4);
...
////		customerDataWasFilled(editor, "Marcin", "Grzejszczak", "30");
////
...
////		this.vaadinUI.init(this.vaadinRequest);
////		this.repository.save(new Customer("Josh", "Long","30"));
////
////		vaadinUI.listCustomers("Long");
////
////		then(getCustomersInGrid()).hasSize(1);
////		then(getCustomersInGrid().get(getCustomersInGrid().size() - 1))
////			.extracting("firstName", "lastName", "finalScore")
////			.containsExactly("Josh", "Long","30");
////	}
//
////	@Test
...
//			String lastName, String finalScore) {
//		this.editor.firstName.setValue(firstName);
//		this.editor.lastName.setValue(lastName);
//		this.editor.finalScore.setValue(finalScore);
//		editor.editCustomer(new Customer(firstName, lastName, finalScore));
//	}
//
//	@Configuration
...
//			this.repository.save(new Customer("Jack", "Bauer","30"));
